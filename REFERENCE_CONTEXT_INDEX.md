...
For current implementation status and new work, read `HANDOFF_MANIFEST.md`, `CURRENT_STATE.md`, `NEW_CHAT_HANDOFF.md`, and `todo.md` first. The complete current specification package is `Massage_Flow_Spec_Package_v1.12.zip`.
...
| `REFERENCE_SPEC_ADDENDUM_v1.6` to `REFERENCE_MVP_VISUAL_GUIDANCE_v1.12` | Later implemented persistence, duration editing, body-region, navigation/history, and shared visual-guidance changes. |
