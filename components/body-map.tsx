...
function DetailedBackBody({ props }: { props: BodyMapProps }) {
  ...
  return (
    <Svg width={286} height={496} viewBox="0 0 280 480">
      ...
      <MapZone d="M76 155 L60 182 C57 193 61 202 70 205 L79 200 L87 164 L85 156 Z" region="FOREARM_PALM" side="LEFT" {...zoneProps} />
      <MapZone d="M204 155 L220 182 C223 193 219 202 210 205 L201 200 L193 164 L195 156 Z" region="FOREARM_PALM" side="RIGHT" {...zoneProps} />
    </Svg>
  );
}
